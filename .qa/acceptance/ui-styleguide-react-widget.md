...
## Intent
Close the gaps between `docs/UI_STYLEGUIDE.md` and `@iamthamanic/autoguide-react`: design tokens, ReviewBadge, FlowStepList, loading/empty/error states, and accessibility (focus trap, ESC, aria-live).
...
- `packages/ui/src/tokens.ts` — shared CSS variable tokens (`@iamthamanic/autoguide-ui`)
